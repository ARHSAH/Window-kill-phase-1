...
public class Main {
    public static void main(String[] args) {
        new TriangleModel(new Point(20, 20), TRIANGLE_LENGTH, TRIANGLE_HP,TRIANGLE_DAMAGE, 0 );
        //new TriangleModel(new Point(30, 30), TRIANGLE_LENGTH, TRIANGLE_HP,TRIANGLE_DAMAGE, 0 );
